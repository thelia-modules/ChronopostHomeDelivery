...
abstract class ChronopostHomeDeliveryDeliveryMode implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ChronopostHomeDelivery\\Model\\Map\\ChronopostHomeDeliveryDeliveryModeTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildChronopostHomeDeliveryPrice[] Collection to store aggregation of ChildChronopostHomeDeliveryPrice objects.
     */
    protected $collChronopostHomeDeliveryPrices;
    protected $collChronopostHomeDeliveryPricesPartial;

    /**
     * @var        ObjectCollection|ChildChronopostHomeDeliveryAreaFreeshipping[] Collection to store aggregation of ChildChronopostHomeDeliveryAreaFreeshipping objects.
     */
    protected $collChronopostHomeDeliveryAreaFreeshippings;
    protected $collChronopostHomeDeliveryAreaFreeshippingsPartial;
     ...
     */
    protected $chronopostHomeDeliveryPricesScheduledForDeletion = null;

    /**
     * An array of objects scheduled for deletion.
     * @var ObjectCollection
     */
    protected $chronopostHomeDeliveryAreaFreeshippingsScheduledForDeletion = null;

    /**
     * Initializes internal state of ChronopostHomeDelivery\Model\Base\ChronopostHomeDeliveryDeliveryMode object.
     */
    ...
    /**
     * Compares this with another <code>ChronopostHomeDeliveryDeliveryMode</code> instance.  If
     * <code>obj</code> is an instance of <code>ChronopostHomeDeliveryDeliveryMode</code>, delegates to
     * <code>equals(ChronopostHomeDeliveryDeliveryMode)</code>.  Otherwise, returns <code>false</code>.
     *
